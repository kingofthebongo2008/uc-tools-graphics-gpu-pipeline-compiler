...
namespace uc
{
    namespace pso
    {
        ...
        namespace
        {
            ...
            template <typename t>
            struct value_visitor : boost::static_visitor<t>
            {
                t operator()(const t& t0) const
                {
                    return t0;
                }
            };
        ...
        template <typename t>
        bool is_nil(const t& t0)
        {
            return boost::apply_visitor(is_nil_visitor(), t0);
        }

        template <typename r, typename t>
        r value(const t& t0)
        {
            return boost::apply_visitor(value_visitor<r>(), t0);
        }
